  ...
  const steps = [
    {
      ...
      icon: <FaPhone className="w-8 h-8 text-indigo-500" />,
    },
    {
      number: 2,
      ...
      icon: <FaQuoteLeft className="w-8 h-8 text-indigo-500" />,
    },
    {
      number: 3,
      ...
      icon: <FaCreditCard className="w-8 h-8 text-indigo-500" />,
    },

    {
      ...
      icon: <FaEnvelopeOpen className="w-8 h-8 text-indigo-500" />,
    },
    {
      number: 5,
      ...
      icon: <FaTruck className="w-8 h-8 text-indigo-500" />, // Using a truck icon to represent service delivery
    },
  ];

  return (
    <div id="booking-steps" className="bg-white pt-35">
      <div className="flex justify-center pb-12 text-4xl font-semibold">
        Five Step Removal
      </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-5">
          {steps.map((step) => (
            ...
            >
              ...
              <div className="flex items-center justify-center w-16 h-16 mb-4 border-4 border-indigo-500 rounded-full">
                {step.icon}
              </div>
