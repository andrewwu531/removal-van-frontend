  ...
  const steps = [
    {
      ...
      icon: <FaPhone className="w-8 h-8 text-indigo-400" />,
    },
    {
      number: 2,
      ...
      icon: <FaQuoteLeft className="w-8 h-8 text-indigo-400" />,
    },
    {
      number: 3,
      ...
      icon: <FaCreditCard className="w-8 h-8 text-indigo-400" />,
    },

    {
      ...
      icon: <FaEnvelopeOpen className="w-8 h-8 text-indigo-400" />,
    },
    {
      number: 5,
      ...
      icon: <FaTruck className="w-8 h-8 text-indigo-400" />, // Using a truck icon to represent service delivery
    },
  ];

  return (
    <div className="pt-8 bg-white mt-35">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-5">
          {steps.map((step) => (
            ...
            >
              ...
              <div className="flex items-center justify-center w-16 h-16 mb-4 border-4 border-indigo-400 rounded-full">
                {step.icon}
              </div>
