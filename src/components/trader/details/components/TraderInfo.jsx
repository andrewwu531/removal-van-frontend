    ...
    <div className="px-11 min-[500px]:px-16 pt-5 min-[500px]:pt-13">
      <div className="flex items-center gap-8 mb-5">
        ...
        <a
          ...
          className="px-5.5 py-2 mt-1.5 font-semibold text-white transition-all duration-300 ease-in-out bg-red-500 rounded-xl text-md hover:bg-red-500 hover:scale-105"
        >
          07943 059 792
        </a>
      </div>
