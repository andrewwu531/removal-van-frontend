...
const BookingHeader = () => {
  return (
    <header className="fixed top-0 left-0 z-50 w-full bg-indigo-700 ">
      {/* Top Bar */}
      <div className="flex items-center justify-start py-3 pl-5 mx-auto">
        {/* Brand */}
        <div className="flex items-center">
          <img src={welcomeIcon} alt="Welcome Icon" className="w-10 h-10" />
        </div>
        {/* <div className="px-6 py-3 font-semibold text-white bg-indigo-600 rounded-xl">
